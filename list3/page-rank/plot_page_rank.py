...
page_titles = []
page_ranks = []
with open('data/Random_matrix/page_rank.txt') as f:
...
plt.loglog(1,page_ranks[0], 'o', label=page_titles[0] + f" -- {page_ranks[0]}")
plt.loglog(2,page_ranks[1], 'o', label=page_titles[1] + f" -- {page_ranks[1]}")
plt.loglog(3,page_ranks[2], 'o', label=page_titles[2] + f" -- {page_ranks[2]}")
plt.loglog(4,page_ranks[3], 'o', label=page_titles[3] + f" -- {page_ranks[3]}")
plt.loglog(5,page_ranks[4], 'o', label=page_titles[4] + f" -- {page_ranks[4]}")
plt.loglog(6,page_ranks[5], 'o', label=page_titles[5] + f" -- {page_ranks[5]}")
plt.loglog(7,page_ranks[6], 'o', label=page_titles[6] + f" -- {page_ranks[6]}")
plt.loglog(8,page_ranks[7], 'o', label=page_titles[7] + f" -- {page_ranks[7]}")
